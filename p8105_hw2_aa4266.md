...
The dimensions of the new table is 1868, 19
...
Upon reformatting the NYC transit data, we got a new table with dimensions : 20548, 10.
...
We get the precipitaion data for years 2016 and 2017 from sheets 5 and 4 of the excel file respectively. We added an extra variable to both the tables for the year. The dimensions of both the datasets are 13, 3 and the combined table with total precipitation from 2016 and 2017 is 13, 5.
